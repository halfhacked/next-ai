...
/** 内置 Provider ID */
type BuiltinProvider = "anthropic" | "minimax" | "glm" | "aihubmix" | "deepseek";
/** 所有 Provider ID（含 custom） */
type AiProvider = BuiltinProvider | "custom" | (string & {});
/** Provider 静态配置 */
...
declare function parseJsonResponse<T>(text: string): T;
...
/** 内置 Provider 注册表 */
declare const BUILTIN_PROVIDERS: Record<BuiltinProvider, AiProviderInfo>;
/** Custom Provider 信息模板 */
declare const CUSTOM_PROVIDER_INFO: Omit<AiProviderInfo, "baseURL" | "sdkType">;
...
/** 默认注册器实例 */
declare const defaultRegistry: AiProviderRegistry;
...
/** 检查 provider 是否有效 */
declare function isValidProvider(id: string, registry?: AiProviderRegistry): boolean;

export { type AiConfig, type AiConfigError, type AiProvider, type AiProviderInfo, AiProviderRegistry, type AiSettingsInput, type AiSettingsReadonly, type AiStorageAdapter, type AiTestConfig, type AiTestResult, BUILTIN_PROVIDERS, type BuiltinProvider, CUSTOM_PROVIDER_INFO, type PromptSection, type PromptTemplate, PromptTemplateRegistry, type SdkType, type TemplateVariable, type TemplateVariables, defaultRegistry, expandTemplate, formatDuration, isValidProvider, parseJsonResponse, resolveAiConfig, validateAiConfig, validateTestConfig };
